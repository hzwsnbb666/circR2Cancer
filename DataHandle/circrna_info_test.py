...
book = xlrd.open_workbook(r"C:\Users\Administrator\Desktop\circR2Cancer\Table\circRNA_info.xlsx")
...
cur = conn.cursor()
# 创建插入SQL语句
query = 'insert into cirrnainfo_circrna_info_test(circRNA,method_of_circRNA_direction,expression_pattern,Chromosome,Region,Strand,Gene_Symbol,host_gene,tissue_or_cell_line,Transcription_interval,Sequence) values (%s, %s, %s, %s,%s,%s,%s, %s,%s,%s,%s)'
