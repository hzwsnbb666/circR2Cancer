...
book = xlrd.open_workbook(r"E:\table\circrna-cancer.xlsx")
...
cur = conn.cursor()
# 创建插入SQL语句
query = 'insert into cirrnainfo_circRNA_cancer(circRNA,disease,method_of_circRNA_direction,expression_pattern,Chromosome,Region,Strand,Gene_Symbol,host_gene,tissue_or_cell_line,Transcription_interval,species,pmid,functional_describution,sequence) values (%s, %s, %s, %s,%s,%s,%s, %s, %s,%s,%s,%s, %s, %s, %s)'
